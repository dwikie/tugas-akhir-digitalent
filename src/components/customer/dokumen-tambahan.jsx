...
import { Button, Form, Row, Select, Col } from "react-bootstrap";
    ...
    <Form noValidate validated={validated} onSubmit={handleSubmit}>
      ...
      <Row>
        <Col xs={7}>
          <Form.Group className="mb-2">
            ...
            <Form.Control name="alamat" type="text" placeholder="" required />
      ...
      <Row>
        <Col xs={7}>
          <Form.Group className="mb-2">
            ...
            <Form.Control name="dokumen" type="file" required />
            <Form.Control.Feedback type="invalid">
      ...
      <div className="d-flex justify-content-end">
        <Button variant="warning" type="submit">
          Submit Kelengkapan Data & Ajukan
        </Button>
      </div>
    </Form>
  );
