    ...
    <>
     <Typography.Title
      ...
      <Form>
        <div className="mb-2">
          <td> No Induk KTP 
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&nbsp;: </td>
        ...
        <div className="mb-2">
          <td> Alamat saat ini 
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp; : </td>
      ...
      <div className="mb-2">
          <td>
            {" "}
            Alamat Rumah &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&nbsp;:{" "}
          </td>
      ...
      <div className="mb-2">
          <td>
            {" "}
            Luas Tanah/Rumah &ensp;&ensp;&ensp;:{" "}
          </td>
        ...
        <div className="mb-2">
          <td>
            Jangka Pembayaran&ensp;&ensp;&ensp;:&ensp;
          </td>
          <td> &ensp;5 Tahun</td>
        </div>
