...
export default function DisplayPengajuanKPR() {
 return (   
  ...
  <Form>
    <div className= "mb-2">
      <td> No Induk KTP &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&nbsp;: </td> 
    ...
    <div className="mb-2">
      <td> Pekerjaan &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;: </td>
      <td> &ensp; Seniman </td>
    </div>
    <div className="mb-2">
    ...
    <div>
      <label> Bukti Selfie KTP &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;: </label>
      <Button variant="link">file_selfie_ktp.pdf</Button>
    </div>
    <div>
      <label> Bukti Slip Gaji &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; : </label>
      <Button variant="link">file_slip_gaji.pdf</Button>
    </div>
    <div>
      <tr>
      <label> Status Verifikasi &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;: &ensp; </label>
      <Button> Menunggu Verifikasi </Button>
      </tr>
    </div>
  </Form>
